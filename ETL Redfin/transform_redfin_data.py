...
def transform_date():
    raw_data_s3_bucket = "s3://redfin-data-engineering/store-raw-data/city_market_tracker.tsv000.gz"
    transform_data_s3_bucket = "s3://redfin-data-engineering/redfin-transform-zone/redfin_data.parquet"
